...
namespace CanoePoloLeagueOrganiserTests
{
    ...
    public class OptimalGameOrderFromCurtailedListTests
    {
        ...
        public void RegionalDiv2()
        {
            ...
            var sut = new OptimalGameOrderWithCurtailment(new TenSecondPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
        ...
        public void OneInputGameShouldResultInThisGameBeingPlayed()
        {
            ...
            var sut = new OptimalGameOrderWithCurtailment(new NoCompromisesPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
        ...
        public void CastleAndLetchworthAndAvonShouldNotPlayTwiceInARow()
        {
            ...
            var sut = new OptimalGameOrderWithCurtailment(new NoCompromisesPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder().OptimisedGameOrder;
        ...
        public void EveryoneShouldGetTheirGamesOutOfTheWayAsQuicklyAsPossible()
        {
            ...
            var gameOrder = new OptimalGameOrderWithCurtailment(new NoCompromisesPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
        ...
        public void RespondWithSomethingWhenPermutationsGetOutOfHand()
        {
            ...
            var gameOrder = new OptimalGameOrderWithCurtailment(new TenSecondPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
        ...
        public void SpeedTest()
        {
            ...
            new OptimalGameOrderWithCurtailment(new NoCompromisesPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
