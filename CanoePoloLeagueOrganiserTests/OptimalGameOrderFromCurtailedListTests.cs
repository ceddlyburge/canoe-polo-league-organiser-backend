...
namespace CanoePoloLeagueOrganiserTests
{
    ...
    public class OptimalGameOrderFromCurtailedListTests
    {
        ...
        public void RegionalDiv2()
        {
            ...
            var sut = new OptimalGameOrderFromCurtailedList(new TenSecondPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
        ...
        public void OneInputGameShouldResultInThisGameBeingPlayed()
        {
            ...
            var sut = new OptimalGameOrderFromCurtailedList(new NoCompromisesPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
        ...
        public void CastleAndLetchworthAndAvonShouldNotPlayTwiceInARow()
        {
            ...
            var sut = new OptimalGameOrderFromCurtailedList(new NoCompromisesPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder().OptimisedGameOrder;
        ...
        public void EveryoneShouldGetTheirGamesOutOfTheWayAsQuicklyAsPossible()
        {
            ...
            var gameOrder = new OptimalGameOrderFromCurtailedList(new NoCompromisesPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
        ...
        public void RespondWithSomethingWhenPermutationsGetOutOfHand()
        {
            ...
            var gameOrder = new OptimalGameOrderFromCurtailedList(new TenSecondPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
        ...
        public void SpeedTest()
        {
            ...
            new OptimalGameOrderFromCurtailedList(new NoCompromisesPragmatiser(), EnumerateAllPermutations(games)).CalculateGameOrder();
